...
import { KnownExt, PostType } from "./posts";
...
const validatePost = (
  ...
  const fanartValidChecks =
    type === PostType.Fanart
      ...
      : {};
  const illustrationRenditionVestigeValidChecks =
    ...
    type === PostType.Vestige
      ? {
          ...
          [`${pathed} should have an image.`]: /\bsrc="assets\/.+"/.test(
            content
          ),
  ...
  return [
    ...Object.entries({
      ...fanartValidChecks,
      ...illustrationRenditionVestigeValidChecks,
      ...mdValidChecks,
      ...validChecks,
      ...vignetteValidChecks,
