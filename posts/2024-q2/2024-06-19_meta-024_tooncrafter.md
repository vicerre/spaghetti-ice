...
<img src="assets/2024-06-18_image-171.gif">
...
When I found out on 2024-05-30 about [ToonCrafter](https://www.reddit.com/1d470rv/) ([and its predecessor family of models](https://github.com/Doubiiu/DynamiCrafter#-crafter-family)), I became glad; diffusion-based image interpolation was the use case I was looking forward to, and technology has advanced to the point it was feasible to run on consumer hardware.
